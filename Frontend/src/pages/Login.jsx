    ...
    <div className="h-screen w-full tracking-wider bg-gray-200 flex items-center justify-center font-hanken p-4 md:p-8 md:pb-20 lg:pb-14 overflow-hidden">
      ...
      {isError && (
        <div className="fixed z-50 left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 tracking-wider w-[90%] sm:w-full max-w-md p-2 border shadow-2xl rounded-lg  border-gray-500 flex flex-col gap-2 bg-white">
          ...
          <div className="px-2 font-semibold text-red-600">Server Error</div>
      ...
      <div className="w-full max-w-6xl bg-white rounded-2xl shadow-xl md:h-full max-h-[187.5] flex flex-col overflow-hidden">
        <div className="flex flex-col md:flex-row flex-1 h-full">
          ...
          <div className="w-full md:w-7/12 lg:w-1/2 h-full px-6 sm:px-12 md:px-8 lg:px-16 xl:px-24 flex flex-col justify-center gap-y-2 lg:gap-y-6 py-4">
            ...
            <Form method="post">
              <div className="space-y-2.5 lg:space-y-3.5 mt-1">
                <div>
                  <label
                    htmlFor="email"
                ...
                <div className="relative">
                  ...
                  <div className="flex flex-col items-center gap-1">
                    ...
                    <div className="text-xs text-blue-600 hover:underline self-end mx-2">
                      <p>Forgot Password?</p>
                    </div>
                  </div>
                </div>
          ...
          <div className="w-full md:w-5/12 lg:w-1/2 h-full bg-[url('/login_image.png')] bg-cover bg-center bg-no-repeat hidden md:flex flex-col items-start justify-between gap-y-6 lg:gap-y-10 p-8 lg:p-12 xl:p-24">
            <div className="flex flex-col gap-5">
              ...
              <p className="text-white text-xs lg:text-sm max-w-md">
                Your secure way to Institutional-grade ceommerce. <br />
                Mange your marketplace operations and luxury curation with
                complete control
              </p>
            </div>
            <div className="grid grid-cols-3 mt-2 w-full max-w-md">
              <div></div>
