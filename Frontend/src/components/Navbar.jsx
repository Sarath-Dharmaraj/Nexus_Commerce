...
function Navbar() {
  ...
  return (
    <>
      <div className="sticky top-0 left-0 z-50 w-full h-auto md:h-20 px-3 md:px-10 lg:px-14 py-2 md:py-0 border-b border-slate-300 flex flex-wrap md:flex-nowrap items-center justify-between bg-slate-50 gap-y-2">
