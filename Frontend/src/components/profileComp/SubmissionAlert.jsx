...
function SubmissionAlert() {
  ...
  return (
    <div className="absolute z-50 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full flex items-center justify-around bg-black/30">
      <div className=" flex flex-col items-start justify-around w-150 border rounded-lg border-slate-200 bg-slate-50 shadow-2xl  tracking-tight text-2xl text-slate-600 px-5">
        <span
