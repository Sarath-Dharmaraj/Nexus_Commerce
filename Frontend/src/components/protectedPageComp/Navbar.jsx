  ...
  return (
    <>
      <div className="sticky top-0 left-0 z-50 w-full h-auto md:h-20 px-3 md:px-10 lg:px-14 py-2 md:py-0 border-b border-slate-400 flex flex-wrap md:flex-nowrap items-center justify-between bg-slate-50 gap-y-2">
        <div className="w-full md:w-auto text-xl md:text-lg lg:text-2xl font-semibold px-4 md:px-0 md:text-left shrink-0">
          Nexus Commerce
        </div>
        ...
        >
          ...
          <div className="relative flex items-center w-full md:w-auto flex-1 lg:flex-0">
            ...
            <input
              ...
              name="search"
              placeholder="Search..."
              className="w-full flex-1 lg:flex-0 md:w-40 lg:w-72 xl:w-96 h-8 md:h-10 text-sm lg:text-base text-slate-600 border border-slate-500 hover:border-blue-200 focus:border-blue-200 focus:outline-none rounded-md pl-8 md:pl-9 lg:pl-10 pr-3 md:pr-4 bg-slate-100"
            />
          </div>
        </div>
